...
import com.sillylife.plankhana.enums.HTTPStatus
import com.sillylife.plankhana.models.responses.BasicResponse
import com.sillylife.plankhana.models.responses.RestError
import com.sillylife.plankhana.utils.CommonUtil
import com.sillylife.plankhana.views.activities.BaseActivity
...
abstract class CallbackWrapper<T> : DisposableObserver<T> {
    ...
    constructor(activity: BaseActivity, message: String) {
        baseActivity = activity
    }
